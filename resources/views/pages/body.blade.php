...
<div class="berita px-[7%] mt-8 border-t-2 border-gray-100">
    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-2xl shadow-2xl  dark:bg-gray-800 dark:border-gray-700 "data-aos="zoom-in">
        <div class="relative overflow-hidden bg-cover bg-no-repeat flex items-center justify-center h-56">
            <img
              ...
              alt="Louvre" />
              <div
              class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden rounded-t-2xl bg-black bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-50"></div>
          </div>
        <div class="p-5">
            <a href="#">
...
<div class="container2 my-12 py-12 mx-auto px-4 md:px-6 lg:px-12">
    ...
    <section class="mb-8 text-gray-800">
      ...
      <div class="flex flex-wrap justify-center">
        ...
        <div class="flex-initial shrink w-full  lg:w-6/12 mb-6 md:mb-0 lg:-ml-12">
          <div class="bg-[#07407D] h-full rounded-lg p-6 lg:pl-12 text-white flex items-center py-12 lg:py-0" style="z-index: -10">
            <div class="lg:pl-12">
              <h3 class="text-2xl font-semibold uppercase mb-6 pb-2">Kontak Kami</h3>
              <h5 class="text-xl font-semibold mb-2">Address:</h5>
              <p class="mb-6">Kec. Riau Silip, Kabupaten Bangka, Kepulauang Bangka Belitung</p>
              <h5 class="text-xl font-semibold mb-4">Follow us:</h5>
              <div class="flex flex-row">
                <svg aria-hidden="true" focusable="false" data-prefix="fab" class="w-6 mr-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
